...
export interface TabBarViewProps extends TabBarAnimationConfigurableProps, TabBarItemConfigurableProps {
    /**
...
export interface TabBarItemProps extends Required<TabBarAnimationConfigurableProps>,
    Required<TabBarItemConfigurableProps>, TabBarConfigsType {
    /**
     * Selected animated index
     */
    selectedIndex: Animated.Value<number>;
