...
const DropDownItemComponent = ({ item, onPressItem, selected = false, activeItemStyle, activeLabelStyle, containerStyleItem, customTickIcon, labelStyle }: ItemProps) => {
    ...
    const container = useMemo(() => enhance([containerStyleItem]) as StyleProp<ViewStyle>, [containerStyleItem])
    return (
...
export const DropDownItem = memo(DropDownItemComponent, (prevProps, nextProps) => isEqual(prevProps, nextProps))
