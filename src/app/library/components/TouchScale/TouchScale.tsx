...
const TouchableScaleComponent = (props: TouchableScaleProps) => {
    ...
    const _onPress = useCallback(() => { runAnimated(1); onPress && onPress() }, [onPress])
    return (
        <TouchableWithoutFeedback onLongPress={_onLongPress} onPressIn={_onPressIn} onPressOut={_onPressOut} onPress={_onPress}>
