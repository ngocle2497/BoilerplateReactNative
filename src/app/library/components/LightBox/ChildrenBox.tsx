import React, { useState, useRef, cloneElement, Children, useEffect, useContext, useCallback } from 'react'
...
export const ChildrenBox = (props: LightBoxProps) => {
    ...
    const { value: activeContext, fn: setActiveContext } = useContext<any>(LightBoxOverlayContext)
