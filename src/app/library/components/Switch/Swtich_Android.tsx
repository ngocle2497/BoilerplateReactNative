    ...
    return (
        <Animated.View style={{ opacity }}>
            <TouchableWithoutFeedback disabled={disable} onPress={_onToggle}>
                <Animated.View style={[styles.track, { backgroundColor: backgroundTrackColor, }]}>
                    <Animated.View style={[styles.thumb, { backgroundColor: backgroundThumbColor, transform: [{ translateX }] }]} />
                </Animated.View>
            </TouchableWithoutFeedback>
        </Animated.View>
    )
